...
private:
    ...
    MatrixElement matrixFromClass[TwoDimensionMatrix::size][TwoDimensionMatrix::size];
...
public:
    ...
    static constexpr MatrixElement getSize(){return size;}
    friend ostream & operator<< (ostream &exit,const TwoDimensionMatrix &m);
    TwoDimensionMatrix operator&&(const TwoDimensionMatrix& matrix) const;
